...
namespace NoSql.MongoDb.Tests.Helpers;
...
public static class DockerHelper
{
    ...
    public static void StartContainer()
    {
        ...
        {
            Image = "mongo",
            Name = "mongo-db-unit-test",
            ExposedPorts = new Dictionary<string, EmptyStruct>() { { 27017.ToString(), new EmptyStruct() } },
                    ...
                    {
                        {
                            ...
                            {
                                new PortBinding { HostPort = 27017.ToString() }
                            }
                        }
                    }
            }
